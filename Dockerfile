...
ENV MYSQL_WORKBENCH_VERSION=${MYSQL_WORKBENCH_VERSION:-6.3.9-1ubuntu16.04-amd64}
ENV MYSQL_WORKBENCH_WORKBENCH=${MYSQL_WORKBENCH_WORKBENCH:-mysql-workbench-community-6.3.9-1ubuntu16.04-amd64.deb}
